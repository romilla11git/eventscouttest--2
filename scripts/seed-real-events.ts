...
const REAL_EVENTS = [
    {
        ...
        marketingStrategy: { audience: "Enterprise tech buyers, government ICT leaders, startup founders", promotion: "Exhibition booth, live AV/IFP demos, brochures, networking dinners", estimatedReach: 5000 }
    },
    {
        ...
        conflictStatus: true,
        marketingStrategy: { audience: "AI developers, tech founders, corporate innovation teams", promotion: "Sponsorship panel, branded materials, LinkedIn ads", estimatedReach: 800 }
    },
    {
        ...
        conflictStatus: false,
        marketingStrategy: { audience: "Government leaders, multilateral organizations, academia, data scientists", promotion: "Exhibition space, official brochures, policy roundtable participation", estimatedReach: 1500 }
    },
    {
        title: "Africa Technology Show (AFTS) Kenya 2026",
        description: "East Africa's premier technology trade show — 5th edition. Co-located with CTW Kenya 2026 and the inaugural Women In Technology and Innovation Africa (WITIA) Summit. Features exhibitors across Smart Cities, Fintech, Consumer Technology, and Industry 4.0. Expected 7,000+ visitors.",
        ...
        conflictStatus: false,
        marketingStrategy: { audience: "Government officials, enterprise IT managers, tech buyers, investors", promotion: "Exhibition booth, live IFP demos, WITIA sponsorship, brochures", estimatedReach: 7000 }
    },
    {
        ...
        conflictStatus: false,
        marketingStrategy: { audience: "Students, teachers, school principals, Ministry of Education officials", promotion: "Category sponsorship, branded robotics kits, demo stations", estimatedReach: 1200 }
    },
    {
        ...
        conflictStatus: false,
        marketingStrategy: { audience: "Education ministers, school administrators, EdTech investors, HR professionals", promotion: "Exhibition booth, panel participation, AI-in-classroom white paper", estimatedReach: 2000 }
    },
    {
        ...
        conflictStatus: false,
        marketingStrategy: { audience: "Procurement officers, school principals, county officials", promotion: "Formal proposal submission, product catalogue, technical specification sheet", estimatedReach: 50 }
    },
    {
        ...
        conflictStatus: true,
        marketingStrategy: { audience: "Strathmore University procurement team, ICT faculty heads", promotion: "Formal proposal, product demo at site, reference client testimonials", estimatedReach: 20 }
    },
    {
        ...
        conflictStatus: false,
        marketingStrategy: { audience: "Ministry IT directors, county ICT officers, enterprise IT managers", promotion: "Sponsorship, branded exhibition stand, networking dinners", estimatedReach: 600 }
    },
    {
        ...
        conflictStatus: false,
        marketingStrategy: { audience: "School principals, university procurement teams, EdTech startups", promotion: "Demo booth, live IFP demonstration, robotics kit interaction station", estimatedReach: 1000 }
    }
];
