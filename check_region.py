...
project_ref = "kykfheakmyhmhcguwhbj"
...
async function check() {{
    ...
    console.log("Could not find tenant in any region on port 6543.");
}}
check();
"""

with open("check_pg_6543.js", "w") as f:
    f.write(node_script)

os.system("node check_pg_6543.js")
